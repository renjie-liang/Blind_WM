...
class RCAN_WM(nn.Module):
    def __init__(self, conv=default_conv):
        super(RCAN_WM, self).__init__()
        ...
        n_resgroups = 3 # args.n_resgroups # 10 5
        ...
        # define tail module
        modules_tail = [
            nn.Conv2d(n_feats + self.Num_wm , n_feats, kernel_size = 3, stride = 1, padding=1),
            nn.ReLU(inplace=True),
